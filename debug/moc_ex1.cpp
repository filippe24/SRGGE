...
QT_MOC_LITERAL(3, 18, 15) // "setNumberCopies"
    ...
    "ex1\0SetFramerate\0\0setNumberCopies"
};
...
void ex1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ex1::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ex1::SetFramerate)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ex1::staticMetaObject = {
    { &Viewer1::staticMetaObject, qt_meta_stringdata_ex1.data,
      qt_meta_data_ex1,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void ex1::SetFramerate(QString _t1)
{
