...
QT_MOC_LITERAL(4, 34, 11) // "startMuseum"
    ...
    "ex5\0SetFramerate\0\0setNumberCopies\0"
    "startMuseum"
};
...
void ex5::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ex5::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ex5::SetFramerate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ex5::SetFramerate(QString _t1)
{
